...
export default function Login() {
  ...
  const handleLogin = () => {
    console.log('apertei no botao de login')
  }
   ...
   <View style={styles.container}>
    <KeyboardAvoidingView style={styles.keyboardView}>
      ...
      <View style={styles.textFooter}>
        <Text style={styles.textNotHaveAccount}>Não tem uma conta? </Text>
        <Text style={styles.textSignUp} onPress={() => {navigation.navigate('SignUp')}}>Cadastre-se</Text>
      </View>
